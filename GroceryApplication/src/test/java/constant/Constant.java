...
public class Constant {
	public static final  int implicitwaitTIMEOUT = 10;
	public static final  int explicitwaitTIMEOUT = 15;
	public static final String lp_verifyDashboardTextwhileLoginwithValidCredentials = "Dashboard text not as expected";
	public static final String lp_verifyErrorMessageWhileLoginWithInvalidCredentials = "Error message not as expected";
	public static final String mp_verifyAlertMsgWhileNewsIsCreatedSuccessfully="News Created Successfully";	
